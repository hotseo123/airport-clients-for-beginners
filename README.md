...
- **第一次用机场客户端，优先选择每个平台第一行**
- **GitHub 下载** 优先放官方仓库、Release 页面、App Store 或官网
- **备用下载** 放教程、镜像、高速下载或补充入口
- `-` 表示暂时没有合适的备用地址，后续会继续补充
- 已停更客户端会尽量标注备份地址，新手更建议选择仍在维护的替代客户端
...
| v2rayN            | ⭐⭐⭐  | [官方](https://github.com/2dust/v2rayn) | [教程](https://github.com/clashbk/clash/wiki/v2rayn) | 老牌工具      |
...
macOS 机场客户端常见选择包括 ClashX Meta、Clash Verge Rev、ClashX、ClashX Pro、Surge、Shadowrocket、Quantumult X 等。新手可优先选择 ClashX Meta、Clash Verge Rev 或 Hiddify。
...
| v2rayN          | ⭐⭐⭐  | [官方](https://github.com/2dust/v2rayn) | [教程](https://github.com/clashbk/clash/wiki/v2rayn) | 通用工具       |

---

## 🐧 Linux 客户端

Linux 机场客户端适合桌面用户、开发者和服务器环境，常见选择包括 Clash Verge Rev、FlClash、Hiddify、v2rayN、sing-box 等。
...
| Mihomo Party    | ⭐⭐⭐  | [官方](https://github.com/mihomo-party-org/mihomo-party/releases) | -  | 技术向     |
| v2rayN          | ⭐⭐⭐  | [官方](https://github.com/2dust/v2rayn) | [教程](https://github.com/clashbk/clash/wiki/v2rayn) | CLI/GUI |
...
Android 机场客户端常见选择包括 Clash Meta for Android、Clash for Android、FlClash、Hiddify、NekoBox、v2rayNG、sing-box 等。建议优先使用仍在维护的客户端。
...
iOS 机场客户端主要通过 App Store 或官网获取，常见选择包括 Shadowrocket、Quantumult X、Surge、Stash、sing-box。iPhone 新手通常优先选择 Shadowrocket。
...
- Windows 新手：优先看 **Clash Verge Rev / Hiddify / v2rayN**
- macOS 新手：优先看 **ClashX Meta / Clash Verge Rev / Hiddify**
- Android 新手：优先看 **Clash Meta for Android / Hiddify / NekoBox**
- iOS 新手：优先看 **Shadowrocket / Quantumult X / Surge**
...
机场客户端、Clash 客户端、Clash 下载、Clash Verge Rev 下载、Clash for Windows 下载、ClashX Meta 下载、Clash Meta for Android 下载、Mihomo 客户端、v2rayN 下载、v2rayNG 下载、sing-box 下载、Shadowrocket 下载、Quantumult X 下载、Surge 下载、OpenClash 下载、PassWall2 下载、OpenWRT 代理客户端。

---

## ⚠️ 免责声明

本仓库仅用于 **客户端软件整理、下载入口归档与学习交流**。  
